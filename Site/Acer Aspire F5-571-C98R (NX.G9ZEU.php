...
?> 
    <div id="templatemo_main">
		...
		<h2 align="center">Ноутбук Acer Aspire F5-571-C98R (NX.G9ZEU.002) Суперціна!</h2>
			<div class="content_half float_l">
				<a  rel="lightbox[portfolio]" href="images/product1/038.jpg"><img src="images/product1/038.jpg" alt="image" /></a>
            </div>
		<?php
