...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
        	...
        	<a  rel="lightbox[portfolio]" href="images/product1/018.jpg"><img src="images/product1/018.jpg" alt="image" /></a>
            </div>
            <div class="content_half float_r">
                <font size="3" color=black face="times new roman"><table>
                    ...
                    <tr>
                        <td>Модель:</td>
                        <td>Aspire F5-571-C98R (NX.G9ZEU.002)</td>
                    </tr>
                    <tr>
                        <td>Виробник:</td>
                        <td>Acer</td>
            ...
            <h5>Опис товару</h5>
            <p>Экран 15.6" (1366x768) WXGA HD LED, матовый / Intel Celeron 2957U (1.4 ГГц) / RAM 4 ГБ / 
			HDD 500 ГБ / Intel HD Graphics / DVD Super Multi / Wi-Fi / 
			Bluetooth 4.0 / веб-камера / Windows 10 Home / 2.4 кг / черный </p> 
            
          <div class="cleaner h50"></div>
            
            <h3>Інші товари</h3>
        	<div class="product_box">
            	<a href="productdetail8.php"><img src="images/product1/028.jpg" alt="" /></a>
                <h3>Ноутбук Acer Aspire F5-571-C98R (NX.G9ZEU.002) Суперціна!</h3>
            ...
            <div class="product_box">
            	<a href="productdetail4.php"><img src="images/product1/04.jpg" alt="" /></a>
            ...
            <div class="product_box no_margin_right">
            	<a href="productdetail5.php"><img src="images/product1/05.jpg" alt="" /></a>
