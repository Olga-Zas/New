...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
        	...
        	<a  rel="lightbox[portfolio]" href="images/product1/019.jpg"><img src="images/product1/019.jpg" alt="image" /></a>
            </div>
            <div class="content_half float_r">
                <font size="3" color=black face="times new roman"><table>
                    ...
                    <tr>
                        <td>Модель:</td>
                        <td>IdeaPad 100-15 (i3-5005/4/1000/GF920)</td>
                    </tr>
                    <tr>
                        <td>Виробник:</td>
                        <td>Lenovo</td>
            ...
            <h5>Опис товару</h5>
            <p>Экран 15.6" (1366x768) HD LED, глянцевый / Intel Core i3-5005U (2.0 ГГц) / RAM 4 ГБ / HDD 1 ТБ / nVidia GeForce 920M,
			1 ГБ / без ОД / LAN / Bluetooth / Wi-Fi / веб-камера / DOS / 2.3 кг / черный</p> 
